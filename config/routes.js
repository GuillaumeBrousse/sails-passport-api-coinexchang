...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  'POST /oauth/v2/token': 'AuthController.login',
  'GET /user/validate_token' : 'AuthController.validate_token',
  'GET /user/logout': 'AuthController.logout',
  'POST /api/user/register' : 'UserController.register',
  'GET /api/wallet' : 'WalletController.findAll',

  'POST /api/deposit' : 'DepositController.create',
  'GET /api/deposit' : 'DepositController.findAll',

  'POST /api/address' : 'AddressController.create',
  'GET /api/address' : 'AddressController.findAll',

  'POST /api/order' : 'OrderController.create',
  'GET /api/order/cancel/:id' : 'OrderController.cancel',
  'GET /api/order' : 'OrderController.findAll',
